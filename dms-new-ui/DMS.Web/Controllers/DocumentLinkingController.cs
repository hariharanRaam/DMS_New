...
namespace DMS.Web.Controllers
{
    ...
    public class DocumentLinkingController : Controller
    {
        ...
        public ActionResult LinkFilesMultiple(string Attribid)
        {
            string validation = "0";
            int Result = 0;
            try
            {
                ...
                Result = ServiceObj.attachfilesMultiple(Attribid);
        ...
        public ActionResult DeLinkFilesMultiples(string Attribid)
        {
            try
            {
                ...
                //int Result = ServiceObj.attachfiles(attachid1, attachid2);
                int Result = ServiceObj.deattachfilesMultiple(Attribid);
                return Json(Result, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
