...
{
    public class DocumentLinking_Service
    {
        //creating data objects for passing values to data methods.
        DocumentLinking_Data DataObj = new DocumentLinking_Data();
        ...
        public int attachfilesMultiple(string Attribid)
        {
            return DataObj.AttachFilesMultiple(Attribid);
        }
        ...
        public int deattachfilesMultiple(string Attribid)
        {
            return DataObj.DeAttachFilesMultiple(Attribid);
        }

        //public string validate(string retval, string retval1)
        //{
        //    return DataObj.validate(retval, retval1);
        //}
    }
}
