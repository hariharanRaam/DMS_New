...
namespace DMS.Data
{
   public class DocumentLinking_Data
    {
       ...
       public int AttachFilesMultiple(string Attribid)
       {
           ...
           {
               con.Open();
               MySqlCommand cmd = new MySqlCommand("Pr_GroupingDocuments", con);
               cmd.CommandType = CommandType.StoredProcedure;
               cmd.Parameters.Add("In_Attribid", MySqlDbType.VarChar).Value = Attribid;
               cmd.Parameters.AddWithValue("In_action", "Link");
               Result = cmd.ExecuteNonQuery();
               con.Close();
               return Result;
           }
       ...
       public int DeAttachFilesMultiple(string Attribid)
       {
           ...
           try
           {
               ...
               cmd.CommandType = CommandType.StoredProcedure;
               cmd.Parameters.Add("In_Attribid", MySqlDbType.VarChar).Value = Attribid;
               cmd.Parameters.AddWithValue("In_action", "Delink");
               Result = cmd.ExecuteNonQuery();
               con.Close();
               return Result;
           }
